...
| No  |       Scenario      | No  |      Case       | No  |     Step          |     test data     |       Expected result
| --  |       --------      | --  |      ----       | --  |     ----          |     ---------     |       ---------------
| 1 | Add specific product to wishlist | 1 | Add specific product with category = T-Shirt to wihlist | 1 | Open Home Page                                               | URL = www.automationpractice.com                                                                   | In wishlist page, total item in wishlist shoul not be 0 |
|   |                                  |   |                                                         | 2 | Sign in using registered account at Sign In page             | email = automationpractice-test01@email.com password = 123456                                      | |
...
| No  |       Scenario      | No  |      Case       | No  |     Step          |     test data     |       Expected result
| --  |       --------      | --  |      ----       | --  |     ----          |     ---------     |       ---------------
| 1 | Add specific product to cart | 1 | Add specific product with category = T-Shirt to cart | 1 | Open Home Page                                | URL = www.automationpractice.com                                                                   | In cart page, should contain valid product name |
